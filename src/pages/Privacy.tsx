...
const Privacy = () => {
  return (
    <Page title={"Datenschutz"}>
      ...
      E-Mail-Adresse:{" "}
      <p>
        <a href="mailto:nachhilfe@gymhaan.de">nachhilfe@gymhaan.de</a>
      </p>
      ...
      <ul className="m-elements">
        ...
        <li>
          <strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher
          Leistungen und Kundenservice; Anmeldeverfahren.
        </li>
        <li>
      ...
      <ul className="m-elements">
        ...
        <li>
          ...
          Symbolen; <strong>Dienstanbieter:</strong> Fonticons, Inc. ,6 Porter
          Road Apartment 3R, Cambridge, MA 02140, USA; <strong>Website:</strong>{" "}
